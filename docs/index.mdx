...
description: Defense and enterprise sector marketing site for Hanzo AI
---

# Hanzo Industries

Defense and enterprise sector marketing site showcasing Hanzo AI products,
research, team, and capabilities for government and enterprise buyers.

- **URL**: [hanzo.industries](https://hanzo.industries)
- **Repository**: [github.com/hanzo-apps/hanzo.industries](https://github.com/hanzo-apps/hanzo.industries)
...
| Language | TypeScript |
| Backend | Hanzo Cloud (api.hanzo.ai — forms, analytics) |
| State | React Query |
...
lib/                 # Utilities, site constants and data
```
...
| Careers | 42 listings, 8 locations, 6 global offices |
